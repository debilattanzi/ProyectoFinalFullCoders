// funcion paara seleccionar el tipo de operacion (alquiler o venta)
...
// funcion para seleccionar el tipo de alquiler (casa o departamento)
...
Algoritmo alquilerPropiedades
	// variables para alquiler de casas
	...
	// variables para alquiler de departamentos
	...
	//variables para precios de los departamentos en alquiler
	...
	Si TipoOperacionAlquiler Entonces
		
		Si AlquilerCasa Entonces          //mostramos detalle de las casas 
			Mostrar casa1
			...
			SI quiereAlquilar = 1 Entonces 
				...
				Segun valorIngresado Hacer // depende la propiedad que desea alquilar se le muestra el contacto del propietario
					1:
		...
		SiNo    //si se decide alquilar un departamento
			Mostrar depto1
